...
$(document).ready(function () {
    ...
    $("#myTable").on('click', '#buttonChon', function () {
        ...
        var outlineTable = "<table id='myTable2' class='striped responsive-table'><thead><tr><th>Mã thiết bị</th><th>Tên thiết bị</th><th>Phân xưởng sử dụng</th><th>Tình trạng thiết bị</th><th></th></tr></thead><tbody id='body-table-wrapper2'></tbody><tr id='buttonTienHanhDieuChuyen'></tr>";
        ...
        $("#buttonTienHanhDieuChuyen").html("<td></td><td></td><td></td><td></td><td class='right'><a href='/phong-cdvt/kiem-dinh-chon' class='btn blue darken - 2'>Tiến hành điều động đăng kiểm</a></td>");
