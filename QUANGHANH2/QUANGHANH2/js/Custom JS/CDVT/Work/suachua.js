...
$(document).ready(function () {
    ...
    $("#myTable").on('click', '#buttonChon', function () {
        ...
        $("#buttonTienHanhDieuChuyen").html("<td></td><td></td><td></td><td></td><td class='right'><a href='/phong-cdvt/sua-chua-chon' class='btn blue darken - 2'>Tiến hành điều động sửa chữa</a></td>");
