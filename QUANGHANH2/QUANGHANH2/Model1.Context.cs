...
namespace QUANGHANH2
{
    ...
    public partial class QuangHanhProject1Entities1 : DbContext
    {
        public QuangHanhProject1Entities1()
            : base("name=QuangHanhProject1Entities1")
        {
        }
        ...
        public virtual DbSet<documentary_big_maintainance_details> documentary_big_maintainance_details { get; set; }
