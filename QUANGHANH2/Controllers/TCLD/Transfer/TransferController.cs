...
namespace QUANGHANHCORE.Controllers.TCLD
{
    public class TransferController : Controller
    {
        ...
        public ActionResult GetData(String selectListJson, String searchMa, String searchTen, String phongbanSearch, String chucVuSearch)
        {
            ...
            //
            List<TCLD_Transfer_SelectAllAvailableEmployee_Result> listNhanVien = new List<TCLD_Transfer_SelectAllAvailableEmployee_Result>();
            ...
            ")";
                ...
                else
                {
                    ...
                    listNhanVien =db.Database.SqlQuery<TCLD_Transfer_SelectAllAvailableEmployee_Result>("TCLD_Transfer_SelectAllAvailableEmployee", 
