            ...
            else
            {
                ...
                catch
                {
                    using (DbContextTransaction transaction = DBContext.Database.BeginTransaction())
                    {
                        try
                        {
                            List<Documentary_moveline_details> details = DBContext.Documentary_moveline_details.Where(x => x.documentary_id == documentary_id).ToList();
                            foreach (Documentary_moveline_details item in details)
                            {
