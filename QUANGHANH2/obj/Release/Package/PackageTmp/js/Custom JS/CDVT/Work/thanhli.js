...
$(document).ready(function () {
    ...
    $("#myTable").on('click', '#buttonChon', function () {
        ...
        $("#buttonTienHanhDieuChuyen").html("<td></td><td></td><td></td><td></td><td class='right'><a href='/phong-cdvt/thanh-li-chon' class='btn blue darken - 2'>Tiến hành thanh lí</a></td>");
