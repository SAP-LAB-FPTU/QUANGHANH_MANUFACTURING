...
$(document).ready(function () {
    ...
    $("#myTable").on('click', '#buttonChon', function () {
        ...
        var outlineTable = "<table id='myTable2' class='striped responsive-table highlight'><thead><tr><th>Mã thiết bị</th><th>Tên thiết bị</th><th>Đơn vị sử dụng</th><th>Trạng thái thiết bị</th><th></th></tr></thead><tbody id='body-table-wrapper2'></tbody><tr id='buttonTienHanhDieuChuyen'></tr>";
        ...
        $("#buttonTienHanhDieuChuyen").html("<td></td><td></td><td></td><td></td><td class='right'><a href='#xacnhan' class='btn blue darken - 2 modal-trigger'>Tiến hành thu hồi</a></td>");
