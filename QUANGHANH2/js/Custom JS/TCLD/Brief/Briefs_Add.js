...
$(document).ready(function () {
    $(".div_them3").on('click', '#buttonThem3', function () {
        ...
        $.getScript('../../lib/datepicker_src/dist/js/datepicker.js', function () {
            $("#table-gd").append('<tr><td id="col' + rowcount + '1"><select class="custom-select" id="gd" required name="giaDinh">' +
                ...
                '</td><td id="col' + rowcount + '3" class="editable"><input id="input' + rowcount + '3" required name="hoTen" style="border:none" /></td><td id="col' + rowcount + '4" class="editable"><input id="input' + rowcount + '4" required name="moiQuanHe" style="border:none" /></td>"' +
                '<td  id="col' + rowcount + '5" class="editable"><input id="input' + rowcount + '5" required name="lyLich" style="border:none" /></td></tr>');
        });
    });
});
