...
$(document).ready(function () {
    $(".div_them3").on('click', '#buttonThem3', function () {
        ...
        $.getScript('../../lib/datepicker_src/dist/js/datepicker.js', function () {
            $("#table-gd").append('<tr><td id="col' + rowcount + '1"><select class="custom-select" id="gd" required>' +
                ...
                '<input id="ns" type="text" class="datepicker-add center form-control resize-form" data-language="vi" placeholder="dd/mm/yyyy" />' +
                '</td><td contenteditable="true" id="col' + rowcount + '3" class="editable"></td><td contenteditable="true" id="col' + rowcount + '4" class="editable"></td>"' +
                '<td contenteditable="true" id="col' + rowcount + '5" class="editable"></td></tr>');
        });
    });
});
...
$(document).ready(function () {
    $(".div_them").on('click', '#buttonThem1', function () {
        ...
        //If there is no data then no row is added
        $.getScript('../../lib/datepicker_src/dist/js/datepicker.js', function () {
            $("#table-htlv1").append('<tr><td contenteditable="true" id="col' + rowcount1 + '1 " class="editable"></td >' +
