...
$(document).ready(function () {
    ...
    $("#myTable").on('click', '#buttonChon', function () {
        ...
        var outlineTable = "<table id='myTable2' class='stripped responsive-table'><thead><tr><th>Mã thiết bị</th><th>Tên thiết bị</th><th>Tình trạng thiết bị</th><th></th></tr></thead><tbody id='body-table-wrapper2'></tbody><tr id='buttonTienHanhDieuChuyen'></tr>";
        ...
        $("#body-table-wrapper2").append("<tr id='" + col1 + "'><td>" + col1 + "</td><td>" + col2 + "</td><td>" + col3 + "</td><td></td><td class='right'><button id='buttonBoChon' class='btn red darken-2' value='" + col1 + "'>Bỏ chọn</button></td></tr>");
        $("#buttonTienHanhDieuChuyen").html("<td></td><td></td><td></td><td></td><td class='right'><a href='/phong-cdvt/dieu-dong-chon' class='btn blue darken - 2'>Tiến hành điều động</a></td>");
