...
using QUANGHANH_MANUFACTURING.Controllers.DK.QuantityReport;

namespace QUANGHANH_MANUFACTURING.Controllers.BGD.QuantityReport
{
    public class CompanyController : Controller
    {
        [HttpGet]
        [Route("ban-giam-doc/bao-cao-san-xuat-than/san-luong-toan-cong-ty")]
        public ActionResult getView()
        {
            return View("/Views/BGD/QuantityReport/CompanyView.cshtml");
        }

        // GET: SanLuongReport
        [HttpGet]
        [Route("ban-giam-doc/bao-cao-san-xuat-than/bao-cao-san-luong-toan-cong-ty")]
        ...
        [Route("ban-giam-doc/bao-cao-san-xuat-than/bao-cao-san-luong-toan-cong-ty-export-excel")]
        [HttpPost]
