...
namespace QUANGHANH_MANUFACTURING.Controllers.KCM
{
    [Auther(RightID = "008")]
    public class InputPlanController : Controller
    {
        ...
        public ActionResult Index()
        {
            using (QuangHanhManufacturingEntities db = new QuangHanhManufacturingEntities())
            {
                ...
                return View("/Views/KCM/InputPlan/InputPlan_Month.cshtml");
            }
        }

        //////////////////////////////GET INFOR/////////////////////////////
        [Route("phong-kcm/ke-hoach-san-xuat-thang/lay-thong-tin")]
        [HttpPost]
        ...
        [Route("phong-kcm/ke-hoach-san-xuat-thang/nhapsnlv")]
        [HttpPost]
        ...
        /////////////////////////////////INSERT OR UPDATE///////////////////////////////
        [Route("phong-kcm/ke-hoach-san-xuat-thang/nhap-du-lieu-hoac-cap")]
        [HttpPost]
