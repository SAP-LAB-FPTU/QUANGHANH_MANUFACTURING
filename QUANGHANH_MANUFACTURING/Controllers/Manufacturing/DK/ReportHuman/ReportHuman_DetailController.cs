...
namespace QUANGHANH_MANUFACTURING.Controllers.DK.ReportHuman
{
            ...
            string sql = @"select a.MaPhongBan,a.KT1,a.CD1,a.QL1,b.om1,b.vld1,b.p1,b.khac1,a.KT2,a.CD2,a.QL2,b.om2,b.vld2,b.p2,b.khac2,a.KT3,a.CD3,a.QL3,b.om3,b.vld3,b.p3,b.khac3,b.tong_nghidai,a.tong_DS,a.QL_CTy, 
                            ROUND((case when (a.KT1 + a.CD1 + a.KT2 + a.CD2 + a.KT3 + a.CD3 + b.vld1 + b.vld2 + b.vld3 + b.om1 + b.om2 + b.om3 + b.p1 + b.p2 + b.p3 + b.khac1 + b.khac2 + b.khac3) != 0 then cast(a.KT1 + a.CD1 + a.KT2 + a.CD2 + a.KT3 + a.CD3 as float) / cast((a.KT1 + a.CD1 + a.KT2 + a.CD2 + a.KT3 + a.CD3 + b.vld1 + b.vld2 + b.vld3 + b.om1 + b.om2 + b.om3 + b.p1 + b.p2 + b.p3 + b.khac1 + b.khac2 + b.khac3) as float) * 100 else 0 end),2) as 'tile' 
							 ...
							 (select nv_d.MaPhongBan, dep.[index]
                               ...
                               , SUM(case when ncv.MaNhomCongViec = 7 and h.Ca = '2' and nv_d.DiLam = '1' then 1 else 0 end) as 'CD2' 
                               , SUM(case when ncv.MaNhomCongViec = 10 and h.Ca = '2' and nv_d.DiLam = '1' then 1 else 0 end) as 'QL2' 
                               , sum(case when ncv.MaNhomCongViec = 6 and h.Ca = '3' and nv_d.DiLam = '1' then 1 else 0 end) as 'KT3' 
                               , SUM(case when ncv.MaNhomCongViec = 7 and h.Ca = '3' and nv_d.DiLam = '1' then 1 else 0 end) as 'CD3' 
                               , SUM(case when ncv.MaNhomCongViec = 10 and h.Ca = '3' and nv_d.DiLam = '1' then 1 else 0 end) as 'QL3'
                               , count(nv_d.MaNV) as 'tong_DS' 
                               , sum(case when ncv.MaNhomCongViec = 10 then 1 else 0 end) as 'QL_CTy' 
                             from 
							 Header_DiemDanh_NangSuat_LaoDong_Detail hdd 
							 left outer join
							 (select d.HeaderID ,n.MaPhongBan, d.MaNV, n.MaCongViec, d.DiLam 
							 from DiemDanh_NangSuatLaoDong d 
							...
							join Department dep on dep.department_id = nv_d.MaPhongBan
	                         ...
	                         (select nv_d.MaPhongBan, SUM(case when nv_d.LyDoVangMat like N'Vô lý do' and h.Ca = '1' and nv_d.DiLam = '0' then 1 else 0 end) as 'vld1' 
                               ...
                               , SUM(case when nv_d.LyDoVangMat like N'Nghỉ phép' and h.Ca = '1' and nv_d.DiLam = '0' then 1 else 0 end) as 'p1' 
                               , SUM(case when nv_d.LyDoVangMat like N'Khác' and h.Ca = '1' and nv_d.DiLam = '0' then 1 else 0 end) as 'khac1' 
                               , SUM(case when nv_d.LyDoVangMat like N'Vô lý do' and h.Ca = '2' and nv_d.DiLam = '0' then 1 else 0 end) as 'vld2' 
                               , sum(case when nv_d.LyDoVangMat like N'Ốm'  and h.Ca = '2' and nv_d.DiLam = '0' then 1 else 0 end) as 'om2' 
                               , SUM(case when nv_d.LyDoVangMat like N'Nghỉ phép' and h.Ca = '2' and nv_d.DiLam = '0' then 1 else 0 end) as 'p2' 
                               , SUM(case when nv_d.LyDoVangMat like N'Khác' and h.Ca = '2' and nv_d.DiLam = '0' then 1 else 0 end) as 'khac2' 
                               , SUM(case when nv_d.LyDoVangMat like N'Vô lý do' and h.Ca = '3' and nv_d.DiLam = '0' then 1 else 0 end) as 'vld3' 
                               , sum(case when nv_d.LyDoVangMat like N'Ốm'  and h.Ca = '3' and nv_d.DiLam = '0' then 1 else 0 end) as 'om3' 
                               , SUM(case when nv_d.LyDoVangMat like N'Nghỉ phép' and h.Ca = '3' and nv_d.DiLam = '0' then 1 else 0 end) as 'p3' 
                               , SUM(case when nv_d.LyDoVangMat like N'Khác' and h.Ca = '3' and nv_d.DiLam = '0' then 1 else 0 end) as 'khac3' 
                               , SUM(case when nv_d.LyDoVangMat in (N'Tai nạn lao động',N'Ốm dài',N'Thai sản',N'Tạm hoãn lao động',N'Vô lý do dài') then 1 else 0 end) as 'tong_nghidai' 
                             from 
							 Header_DiemDanh_NangSuat_LaoDong_Detail hdd 
							 left outer join
							 (select d.HeaderID ,n.MaPhongBan, d.MaNV, n.MaCongViec, d.DiLam, d.LyDoVangMat
							 from DiemDanh_NangSuatLaoDong d 
							 left outer join NhanVien n on n.MaNV = d.MaNV) as nv_d on hdd.HeaderID = nv_d.HeaderID and hdd.MaPhongBan = nv_d.MaPhongBan
                             left outer join Header_DiemDanh_NangSuat_LaoDong h on nv_d.HeaderID = h.HeaderID 
