                ...
                using (var stream = new MemoryStream())
                {
                    ...
                    using (var doc = WordprocessingDocument.Open(stream, true))
                    {
                        ...
                        foreach (DieuDongModel d in listNhanVien)
                        {
                            ...
                            tc1.Append(new Paragraph(new Run(new MediaTypeNames.Text((i).ToString()))));
                            tr.Append(tc1);

                            TableCell tc2 = new TableCell();
                            tc2.Append(new Paragraph(new Run(new MediaTypeNames.Text(d.HoTen))));
                            tr.Append(tc2);

                            TableCell tc3 = new TableCell();
                            tc3.Append(new Paragraph(new Run(new MediaTypeNames.Text(d.MaNV))));
                            tr.Append(tc3);

                            TableCell tc4 = new TableCell();
                            tc4.Append(new Paragraph(new Run(new MediaTypeNames.Text(d.DonViHienTai))));
                            tr.Append(tc4);

                            TableCell tc5 = new TableCell();
                            tc5.Append(new Paragraph(new Run(new MediaTypeNames.Text(d.DonViMoi))));
                            tr.Append(tc5);

                            TableCell tc6 = new TableCell();
                            tc6.Append(new Paragraph(new Run(new MediaTypeNames.Text(d.ChucVu.tenChucVu))));
                            tr.Append(tc6);

                            TableCell tc7 = new TableCell();
                            tc7.Append(new Paragraph(new Run(new MediaTypeNames.Text(d.BacLuong))));
                            tr.Append(tc7);

                            TableCell tc8 = new TableCell();
                            tc8.Append(new Paragraph(new Run(new MediaTypeNames.Text(d.MucLuong.ToString()))));
                            tr.Append(tc8);

                            TableCell tc9 = new TableCell();
                            tc9.Append(new Paragraph(new Run(new MediaTypeNames.Text(d.PhuCap.ToString()))));
                            tr.Append(tc9);

                            TableCell tc10 = new TableCell();
                            tc10.Append(new Paragraph(new Run(new MediaTypeNames.Text(d.LyDo.ToString()))));
                            tr.Append(tc10);
                ...
                using (var stream = new MemoryStream())
                {
                    ...
                    using (var doc = WordprocessingDocument.Open(stream, true))
                    {
                        ...
                        foreach (DetailDieuDongClass d in list)
                        {
                            ...
                            TableCell tc2 = new TableCell();
                            tc2.Append(new Paragraph(new Run(new MediaTypeNames.Text(d.Ten))));
                            tr.Append(tc2);
                            ...
                            TableCell tc4 = new TableCell();
                            tc4.Append(new Paragraph(new Run(new MediaTypeNames.Text(d.MaDonViCu))));
                            tr.Append(tc4);

                            TableCell tc5 = new TableCell();
                            tc5.Append(new Paragraph(new Run(new MediaTypeNames.Text(d.MaDonViMoi))));
                            tr.Append(tc5);

                            TableCell tc6 = new TableCell();
                            tc6.Append(new Paragraph(new Run(new MediaTypeNames.Text(d.ChucVuMoi))));
                            tr.Append(tc6);

                            TableCell tc7 = new TableCell();
                            tc7.Append(new Paragraph(new Run(new MediaTypeNames.Text(d.BacLuongMoi == null ? "0" : d.BacLuongMoi))));
                            tr.Append(tc7);

                            TableCell tc8 = new TableCell();
                            tc8.Append(new Paragraph(new Run(new MediaTypeNames.Text(String.Format("{0:N2}", Convert.ToDouble(d.MucLuongMoi.ToString()))))));
                            tr.Append(tc8);

                            TableCell tc9 = new TableCell();
                            tc9.Append(new Paragraph(new Run(new MediaTypeNames.Text(String.Format("{0:n0}", d.PhuCap == null ? "" : d.PhuCap.ToString())))));
                            tr.Append(tc9);

                            TableCell tc10 = new TableCell();
                            tc10.Append(new Paragraph(new Run(new MediaTypeNames.Text(d.LyDoDieuDong.ToString()))));
                            tr.Append(tc10);
