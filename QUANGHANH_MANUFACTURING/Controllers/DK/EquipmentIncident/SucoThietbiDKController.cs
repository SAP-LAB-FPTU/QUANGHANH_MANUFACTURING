...
using OfficeOpenXml;
using QUANGHANH_MANUFACTURING.Controllers.CDVT.Suco;

namespace QUANGHANH_MANUFACTURING.Controllers.DK.EquipmentIncident
{
    public class SucoThietbiDKController : Controller
    {
        //[Auther(RightID = "19")]
        [Route("phong-dieu-khien/bao-cao-su-co-thiet-bi")]
        [HttpGet]
        public ActionResult Index()
        {
            ...
            return View("/Views/DK/SucoThietbi.cshtml");
        }

        //[Auther(RightID = "20")]
        [Route("phong-dieu-khien/bao-cao-su-co-thiet-bi/add")]
        [HttpPost]
        ...
        //[Auther(RightID = "21")]
        [Route("phong-dieu-khien/bao-cao-su-co-thiet-bi/edit")]
        [HttpPost]
        ...
        //[Auther(RightID = "21")]
        [Route("phong-dieu-khien/bao-cao-su-co-thiet-bi/update")]
        [HttpPost]
        ...
        //[Auther(RightID = "170")]
        [Route("phong-dieu-khien/bao-cao-su-co-thiet-bi/export")]
        public void Export()
        {
        ...
        //[Auther(RightID = "21")]
        [Route("phong-dieu-khien/bao-cao-su-co-thiet-bi/get")]
        [HttpPost]
        ...
        //[Auther(RightID = "20")]
        [Route("phong-dieu-khien/bao-cao-su-co-thiet-bi/getDepartment")]
        [HttpPost]
