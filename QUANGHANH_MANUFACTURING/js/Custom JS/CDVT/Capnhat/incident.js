...
$(document).ready(function () {
    ...
    $("#them").click(function () {
        dem++;
        $("#TableABC").append("<tr><td>"+dem+"</td><td><input type='text' class='form-control' placeholder='Mã thiết bị' /></td><td><input type='text' class='form-control' placeholder='Loại sự cố' /></td></tr>");
    });
